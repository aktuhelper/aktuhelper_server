...
export interface ApiAnalyticAnalytic extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    registeredUsers: Schema.Attribute.Integer;
    totalViews: Schema.Attribute.Integer;
    unregisteredVisitors: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiAptiQuestionAptiQuestion
  extends Struct.CollectionTypeSchema {
  collectionName: 'apti_questions';
  info: {
    displayName: 'apti-question';
    pluralName: 'apti-questions';
    singularName: 'apti-question';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::apti-question.apti-question'
    > &
      Schema.Attribute.Private;
    marks: Schema.Attribute.Integer;
    option: Schema.Attribute.JSON & Schema.Attribute.Required;
    practice_set: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    has_branches: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::course.course'
...
export interface ApiInterviewQuestionInterviewQuestion
  extends Struct.CollectionTypeSchema {
  collectionName: 'interview_questions';
  info: {
    displayName: 'interview-question';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::interview-question.interview-question'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    question: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['hr', 'technical']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPracticeSetPracticeSet extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    apti_questions: Schema.Attribute.Relation<
      'oneToMany',
      'api::apti-question.apti-question'
    >;
    attempted: Schema.Attribute.Integer;
    category: Schema.Attribute.Enumeration<
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    duraton: Schema.Attribute.String & Schema.Attribute.Required;
    isAttempted: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::practice-set.practice-set'
    > &
      Schema.Attribute.Private;
    marksScored: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    question: Schema.Attribute.Integer;
...
export interface ApiSubjectSubject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    subject_code: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiTestAttemptTestAttempt extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    unattempted: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    >;
    wrongAnswers: Schema.Attribute.Integer;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::apti-question.apti-question': ApiAptiQuestionAptiQuestion;
      'api::branch.branch': ApiBranchBranch;
      'api::course.course': ApiCourseCourse;
      'api::interview-question.interview-question': ApiInterviewQuestionInterviewQuestion;
      'api::job.job': ApiJobJob;
      'api::material.material': ApiMaterialMaterial;
      'api::practice-set.practice-set': ApiPracticeSetPracticeSet;
